...
export const Header: React.FC = () => {
  ...
  return (
    <nav className="relative left-0 right-0 z-12 h-[70px] w-[1620px] mx-auto mt-[20px] pt-[14px] pr-[24px] pb-[20px] pl-[24px] rounded-[8px] flex flex-wrap items-center justify-between bg-white shadow">
      ...
      <ul className="flex flex-wrap justify-center gap-4 text-sm text-black">
        ...
        <Link to="/" className="cursor-pointer font-Rubik">Science</Link>
        <Link to="/" className="cursor-pointer">Podcasts</Link>
        <Link to="/" className="cursor-pointer">Trainers</Link>

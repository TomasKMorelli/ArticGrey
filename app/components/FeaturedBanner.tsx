  ...
  return (
    ...
    <div className="w-full bg-[#F6F6F5] mt-[3px]">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center px-6 md:px-[19px] py-[24px] gap-6 md:gap-8 w-full max-w-[1600px] mx-auto">
        ...
        <div className="flex flex-wrap  md:gap-[29px] ml-[52px] justify-start md:justify-end">
          {[
            "rollingreal.png",
            "men.png",
            "laWeekly.png",
            ...
            <div
              key={idx}
              className="bg-white rounded-lg shadow-sm w-[95px] h-[40px] flex items-center justify-center"
            >
              <img
                src={`/assets/${img}`}
                alt={`img-${idx}`}
                className="object-contain max-h-[30px] max-w-[180px]"
              />
            </div>
          ))}
        </div>
